...
->where('lote.id','=', $id)
    ...
    @if ($p->departamento_id==auth::user()->departamento_id)
    <tr>
...
<table>
    <tr>
    <td colspan="4">Total de Entrada</td> <td>Total de Saida</td><td>Existência Lote</td>
</tr>
<tr>
<td colspan="4">{{$e}}</td> <td>{{$s}}</td><td>{{$e-$s}}</td>
</tr>
</table>
</body>
</html>
